...
Since the limiting distribution is also stationary an alternate method is to find the limiting/stationary distribution using the stationarity equations.
