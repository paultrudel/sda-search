...
Expanding on the definition of the limiting distribution we obtain the stationary equations of the chain and ultimately the definition of the stationary distribution of the chain. The stationary distribution exists if and only if the limiting distribution exists and the chain has a finite number of states. The stationary distribution of a Markov chain is unique.
